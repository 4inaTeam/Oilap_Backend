...
from .views import UserCreateView, ClientCreateView, UserListView, CurrentUserView, UserProfileView, SearchClientByCIN, UserDeactivateView,UserDeleteView, ClientUpdateView
