...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'created_at', 'estimation_time', 'end_time', 'payement'  # Added payement field
        ]
        read_only_fields = [
    ...
    def update(self, instance, validated_data):
        ...
        logger.info(
            f"Product {instance.id} updated successfully. Status: {updated_instance.status}, Payment: {updated_instance.payement}")
